...
import { SettingRow, SettingRowDropdown } from './types';

const SettingRowDropdown = ({
  settings,
  toggle
}: {
  settings: SettingRow<SettingRowDropdown>;
...
export default SettingRowDropdown;
